...
Page({
  ...
  init: function(){
    var that = this
    request('/app/coteCrop/list', 'post', {
  ...
  goChangePlot(e){
    ...
    wx.navigateTo({
      url: '/pages/create/plant-change-plot/index?cote=' + o
    })
  },
  //跳转批次列表
  gobatchList(e){
    ...
    wx.navigateTo({
      url: '/pages/create/plant-batch-list/index?plotId=' + id
    })
  },
  //跳转创建地块
  goCreatPlot(){
    wx.navigateTo({
      url: '/pages/create/plant-creat-plot/index'
    })
  },
  //点击删除
  delFun(e) {
