      ...
      success(res) {
        ...
        qqmapsdk.reverseGeocoder({
          ...
          success: function (res1) {
            ...
            request('/app/coteBee/add', 'post', {
              'coteBee.name': that.data.name,
              'coteBee.farm': wx.getStorageSync('farms'),
              'coteBee.longitude': longitude,
              'coteBee.latitude': latitude,
              'coteBee.path': address,
              'coteBee.img': that.data.img
            }).then(res2 => {
              wx.navigateBack()
            })
          },
