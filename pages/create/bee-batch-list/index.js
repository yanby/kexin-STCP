...
Page({
  ...
  init() {
    request('/app/batch/list', 'post', {
      ...
      console.log(res);
      this.setData({
        cropResult: res.data.beeResult.list,
  ...
  goChangeBatch(e){
    ...
    wx.navigateTo({
      url: '/pages/create/bee-change-batch/index?batch=' + o
    })
  },
  //跳转创建批次
  goCreatBatch(){
    wx.navigateTo({
      url: '/pages/create/bee-creat-batch/index?plotId=' + this.data.plotId
    })
  },
  //点击删除
  delFun(e){
  ...
  onReachBottom: function () {
    ...
    request('/app/batch/list', 'post', {
      ...
      console.log(res);
      this.setData({
        cropResult: that.data.cropResult.concat(res.data.beeResult.list),
        nextPage: res.data.beeResult.nextPage
      })
    })
